...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = ActorNode,
		meta = (OnlyPlaceable, AllowPrivateAccess = "true", ForceRebuildProperty = "ActorTemplate"))
